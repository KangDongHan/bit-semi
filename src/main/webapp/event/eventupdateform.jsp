...
<form action="event/eventupdateaction.jsp" method="post" style="margin-top: 30px; margin-bottom:30px;">
...
<div class="container">
  ...
  <table class="table table-hover">
    <tbody>
      <tr>
      	<td><input type="text" class="form-control" placeholder="제목" name="subject" required="required" maxlength="40"></td>
      </tr>
      <tr>
      	<td>
